...
export const Navbar = () => {
    ...
    return (
        <header className={`fixed top-0 left-0 right-0 transition-[padding,box-shadow]  duration-500 ${isScrolled ? "glass-strong py-3" : "bg-transparent py-5"} z-50`}>
            <nav className="container mx-auto px-6 flex items-center justify-between">
                ...
                <div className="hidden md:block">
                    <Button size="sm" onClick={()=>window.location.href = "#contact"}>Contact Me</Button>
                </div>
